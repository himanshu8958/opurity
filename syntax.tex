...
In the sequel, we will use the symbol $\proc$ (as a metavariable) to represent the library/procedure.
We use $\procname$ (as a metavariable) to represent the \emph{name} of the procedure.
