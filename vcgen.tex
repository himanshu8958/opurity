...
We say that a pure feasible execution $\pi$ strongly satisfies the invariant if for every function $f$
that is compatible with $\{\pi\}$, we have $(\pi,f) \models \inv$. 
...
$\pi$ is both pure and strongly satisfies the invariant.
