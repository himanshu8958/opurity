r% This is LLNCS.DEM the demonstration file of
...
Dynamic programming is a widely used technique to write efficient
programs. This approach uses memoization to store pre-computed
solutions to the sub-problem so that it can lookup the solution when
...
mention a (the) mathematical fucntion that the procedure is supposed
to mimic.
