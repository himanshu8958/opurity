...
%% There will be two blank lines before and after the Abstract. \dots
  ...
  are not observable to other procedures (or self).
...
mimics the input-output behaviour of the given procedure. Thus, the
input-output behaviour of the procedure is independent of the global
state. This has many applications. For instance, non-optimal
implimentations of dynamic programming algorithms that do not use
memoization can be refactored to use memoization automatically.
%% implementations of
%% dynamic programming problems without memoization mimic the
%% input-output behaviour of the implementations with
%% memoization
Checking whether a given procedure is OP, is
...
%% (function) .
Hence, in the absence of global variables, all procedures are a
...
will not only check the validity of the invariat but also that the
given procedure is OP. 
...
partitoning the set of methods into ``pure'', ``secret'' and ``query''
