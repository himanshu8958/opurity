...
%% There will be two blank lines before and after the Abstract. \dots
  ...
  procedure. Inorder to tame interference between the runtime checking
  ...
  If not, such a procedue is called \textit{observationally
...
set of global states that are encountered at the boundries of the procedure,
