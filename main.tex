...
%% There will be two blank lines before and after the Abstract. \dots
  ...
  JML, Eiffel allow procedure calls in the contracts of the procedure.
  The specification must not alter the behaviour of the
  implimentation, to impose this behaviour a notion of purity is
  needed for procedures which is not overly restrictive. Strong purity
  allows no side effects whereas weak purity allows no side effects on
  pre-existing objects. Another direction : do side-effects affect the
