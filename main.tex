...
\begin{definition}[path condition ( invariant $\inv$, procedure $\foo$)]
  ...
  aruments to the outgoing values of the global variables and the
...
\subsection{is invariant inductive}
