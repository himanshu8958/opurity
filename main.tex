...
%% The static analysis approaches presented in this paper are
%% parameterized on an invariant. The invariant represents the set of
%% reachable global states in the given procedure. Invariant is a formula
%% in logic with uninterpreted functions, where the uninterpreted
%% function is assumed to be represent the behaviour of the given
%% procedure.
...
\begin{definition}[observational purity(set of state)]
